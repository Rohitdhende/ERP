      ...
      >
        ...
        >
          ...
          >
            ...
            <OutlinedInput
              required
              id="religion-input-box"
              onChange={handleForm('Religion')}
            />
          </FormControl>
          <FormControl
            sx={{
        ...
        >
          ...
          >
            ...
            <OutlinedInput
              required
              id="post_no-input-box"
              onChange={handleForm('post_no')}
            />
          </FormControl>
          <FormControl
            sx={{
        ...
        >
          ...
          >
            ...
            <OutlinedInput
              required
              id="pet_name-input-box"
              onChange={handleForm('pet_name')}
            />
          </FormControl>
          <FormControl
            sx={{
